...
class [[nodiscard]] PiecewiseQuinticCurve2 final : public Curve2<PiecewiseQuinticCurve2<T>, T> {
  ...
  public:
    ...
    [[using gnu: flatten, leaf]] explicit PiecewiseQuinticCurve2(
        ...
        PiecewiseQuinticFunction1<Vec2<T>, T> temp_vec2_of_s{
        ...
        vec2_of_s_ = PiecewiseQuinticFunction1<Vec2<T>, T>{
    ...
    T curvature(T s) const noexcept {
        ...
        const std::vector<Vec2<T>>& d4ys = vec2_of_s_.d4ys();
  ...
  private:
    ...
    PiecewiseQuinticFunction1<Vec2<T>, T> vec2_of_s_;
};
