...
inline void serialize(
    Archive& ar, ::boyle::math::OsqpSettings& obj, const unsigned int version
) noexcept {
    ar& obj.device;
...
[[using gnu: always_inline]]
inline void serialize(
    Archive& ar, ::boyle::math::OsqpInfo& obj, const unsigned int version
) noexcept {
...
[[using gnu: always_inline]]
inline void serialize(
    Archive& ar, ::boyle::math::OsqpResult& obj, const unsigned int version
) noexcept {
    ar& obj.prim_vars;
